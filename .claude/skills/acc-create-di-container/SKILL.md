...
description: Generates DI Container configuration for PHP 8.2. Creates module classes, service providers, container configuration, and autowiring setup. Supports Symfony, Laravel, and PHP-DI patterns. Includes unit tests.
---
...
Generates Dependency Injection container configuration components for PHP 8.2 following DDD and Clean Architecture principles.
