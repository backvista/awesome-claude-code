...
description: Generates test doubles (Mocks, Stubs, Fakes, Spies) for PHP 8.2. Creates appropriate double type based on testing needs with PHPUnit MockBuilder patterns.
---
