...
description: Generates PSR-13 Hypermedia Links implementation for PHP 8.2. Creates LinkInterface, EvolvableLinkInterface, and LinkProviderInterface for HATEOAS support. Includes unit tests.
---
