...
description: Generates Saga pattern components for PHP 8.2. Creates Saga interfaces, steps, orchestrator, state management, and compensation logic with unit tests.
---
