...
description: Generates PHPUnit unit tests for PHP 8.2. Creates isolated tests with AAA pattern, proper naming, attributes, and one behavior per test. Supports Value Objects, Entities, Services.
---

# Unit Test Generator

Generates PHPUnit 11+ unit tests for PHP 8.2 classes.
