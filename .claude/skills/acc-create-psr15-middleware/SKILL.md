...
description: Generates PSR-15 HTTP Middleware implementation for PHP 8.2. Creates MiddlewareInterface and RequestHandlerInterface with pipeline composition. Includes unit tests.
---
