...
description: Generates PSR-14 Event Dispatcher implementation for PHP 8.2. Creates EventDispatcherInterface, ListenerProviderInterface, and StoppableEventInterface with event propagation. Includes unit tests.
---
