...
description: Generates PSR-16 Simple Cache implementation for PHP 8.2. Creates CacheInterface with get/set/delete operations and TTL handling. Includes unit tests.
---
