...
description: Generates Circuit Breaker pattern for PHP 8.2. Creates resilience component protecting against cascading failures with state management, fallback support, and metrics. Includes unit tests.
---
