...
description: Generates Transactional Outbox pattern components for PHP 8.2. Creates OutboxMessage entity, repository, publisher, and processor with unit tests.
---
