...
description: Generates Composite pattern for PHP 8.2. Creates tree structures with uniform treatment of individual and composite objects. Includes unit tests.
---
