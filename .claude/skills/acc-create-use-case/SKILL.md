...
description: Generates Application Use Cases for PHP 8.2. Creates orchestration services that coordinate domain objects, handle transactions, and dispatch events. Includes unit tests.
---
