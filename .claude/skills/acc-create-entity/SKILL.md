...
description: Generates DDD Entities for PHP 8.2. Creates identity-based objects with behavior, state transitions, and invariant protection. Includes unit tests.
---
