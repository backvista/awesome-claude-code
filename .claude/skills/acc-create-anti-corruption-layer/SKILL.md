...
description: Generates DDD Anti-Corruption Layer for PHP 8.2. Creates translation layer between bounded contexts or external systems. Includes adapters, translators, facades, and unit tests.
---
