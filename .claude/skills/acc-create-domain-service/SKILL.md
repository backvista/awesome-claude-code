...
description: Generates DDD Domain Services for PHP 8.2. Creates stateless services for business logic that doesn't belong to entities or value objects. Includes unit tests.
---
