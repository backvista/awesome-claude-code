...
description: Generates State pattern for PHP 8.2. Creates state machines with context, state interface, and concrete states for behavior changes. Includes unit tests.
---
