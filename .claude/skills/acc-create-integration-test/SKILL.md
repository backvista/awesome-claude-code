...
description: Generates PHPUnit integration tests for PHP 8.2. Creates tests with real dependencies, database transactions, HTTP mocking. Supports repositories, API clients, message handlers.
---

# Integration Test Generator

Generates PHPUnit 11+ integration tests for PHP 8.2 infrastructure components.
