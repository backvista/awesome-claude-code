...
## Priority 1 — Enterprise / Integration Patterns (6 skills)
...
- `acc-create-idempotent-consumer` — Idempotent Consumer / дедупликация сообщений
- `acc-create-dead-letter-queue` — Dead Letter Queue handler
- `acc-create-timeout` — Timeout pattern для resilience

## Priority 2 — CQRS / Event Sourcing (3 skills)
...
## Priority 3 — API / Infrastructure (4 skills)
